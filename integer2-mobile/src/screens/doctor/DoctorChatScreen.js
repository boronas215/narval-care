// DoctorChatScreen.js (modificado)
...
const DoctorChatScreen = ({ navigation }) => {
      ...
      >
        ...
        <View style={styles.contactInfo}>
          <View style={styles.contactHeader}>
            <Text style={styles.contactName}>{item.prinombre} {item.apepat}</Text>
      ...
      {contacts.length > 0 ? (
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptySubtext}>
            Los pacientes asignados a ti aparecerán aquí
          </Text>
        </View>
      )}
    </View>
